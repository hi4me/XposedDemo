package foo.ree.demos.x05th.hook;
...
public class XBuild {
    ...
    public void AndroidSerial(XC_LoadPackage.LoadPackageParam loadPkgParam){
        try {
            ...
            Log.d("chao","AndroidSerial:"+SharedPref.getXValue("serial")+"："+Thread.currentThread().getName());
            Log.d("chao","AndroidSerial:"+SharedPref.getXValue("getBaseband")+Process.myPid());
